...
public class AllStudentLiving extends javax.swing.JFrame {
    ...
    public AllStudentLiving() {
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery(" select * from student where status='living' ORDER BY roomNo ASC");
            while(rs.next())
            {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile Number", "Father Name", "Mother Name", "Email", "Address", "College Name", "Aadhaar Numberl", "Room Number"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 671, 430));
